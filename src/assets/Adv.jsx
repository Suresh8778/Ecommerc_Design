        ...
        <div className='row mx-auto'>
            <div className="adv-con col-12 col-lg-6 col-md-6 p-2 px-lg-5 pt-lg-5">
                ...
                <div className='adv-img d-flex pt-2'>
                    <img src={Adv1} alt='Adv-image' className='image-fluid' width="120px"></img>
                    <img src={Adv2} alt='Adv-image' className='image-fluid' width="120px"></img>
                </div>
                </div>
            </div>
            <div className="col-12 col-md-6 col-lg-6 px-lg-5 pt-lg-5 text-center">
                <img className="image-fluid mob-img" src={Mobile} alt='banner' height="600px"></img>
            </div>
        </div>
    </div>
    </>
